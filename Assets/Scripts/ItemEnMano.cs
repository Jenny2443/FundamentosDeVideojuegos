...
public class ItemEnMano : MonoBehaviour
{
    ...
    /* El problema de c�mo lo he hecho reside en que el array del inventario, solo recoge la referencia
     * al item. Cuando hago inventory[i] = item, s�lo est� marcando el lugar en memoria de donde se encuentra
     * el item, en vez de crearse una copia y guardarlo. Por ello, aqui, si lo quiero poner en la mano,
     * debo usar el item en s�, jugando con su posicion, y si cojo otra cosa, pongo lo que tenia en la mano en 
